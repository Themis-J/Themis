...
@FilterDefs(
		{
			...
			@org.hibernate.annotations.FilterDef(name="idDateFilter", 
					parameters = {
					@org.hibernate.annotations.ParamDef(name="referenceTime", type="com.jdc.themis.dealer.data.hibernate.type.PersistentTimestamp"), 
					@org.hibernate.annotations.ParamDef(name="referenceDate", type="com.jdc.themis.dealer.data.hibernate.type.PersistentLocalDate")}),
...
@Filters( {
    ...
    @Filter(name="idDateFilter", condition="validDate = :referenceDate and timestamp < :referenceTime and timeEnd >= :referenceTime"),
...
public class InventoryDuration implements TemporalEntity, Serializable {
	...
	public static final String FILTER_VALIDATE = "idDateFilter";
