...
angular.module('keyPostSalesRevenuePerMargin.controllers', [])
	.controller('keyPostSalesRevenuePerMarginCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
		/**
		 * Global functions
		 */
        ...
        $scope.draw = function (restClient, params) {
	            ...
	            restClient(params, function(data) {
	            	...
	            	for (var i=0; i<previousDetail.length; i++) {
	            		...
	            		chartData.series.previous[i] = previousDetail[i].revenue.amount * 100;
	            		chartData.series.previousReference[i] = previousDetail[i].revenue.reference * 100;
	            		...
	            		chartData.gridData[i].amount = previousDetail[i].revenue.amount * 100;
	            	};
