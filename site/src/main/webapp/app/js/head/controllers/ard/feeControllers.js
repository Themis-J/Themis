...
angular.module('ardFee.controllers', []).controller('ardFeeCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function ($scope, restClient, reportService, config) {
    /**
     * Global functions
     */
