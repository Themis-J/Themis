...
angular.module('ardFactory.controllers', [])
	.controller('ardFactoryCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
		/**
		 * Global functions
		 */
