...
angular.module('ardInsurance.controllers', []).controller('ardInsuranceCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
	/**
	 * Global functions
	 */
