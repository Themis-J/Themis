...
angular.module('ardOverall.controllers', [])
    .controller('ardOverallCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function ($scope, restClient, reportService, config) {
        /**
         * Global functions
         */
