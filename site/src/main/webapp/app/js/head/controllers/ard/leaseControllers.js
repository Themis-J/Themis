...
angular.module('ardLease.controllers', []).controller('ardLeaseCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function ($scope, restClient, reportService, config) {
    /**
     * Global functions
     */
