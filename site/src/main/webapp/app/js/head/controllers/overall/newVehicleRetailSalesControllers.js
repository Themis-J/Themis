...
angular.module('overallNewVehicleRetailSales.controllers', []).controller('overallNewVehicleRetailSalesCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
		/**
		 * Global functions
		 */
    	...
    	$scope.showReport = function() {
        	...
        	$scope.draw(restClient(config.currentMode).queryNewVehicleRetailSalesReport, params);
        };
