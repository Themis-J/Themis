...
angular.module('maintenanceIncome.controllers', []).controller('maintenanceIncomeCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
	/**
	 * Global functions
	 */
	...
	$scope.showReport = function() {
		...
		$scope.draw(restClient(config.currentMode).queryMaintenanceIncomeReport, params);
	};
