...
angular.module('keyPostSalesAllOpProfitPerMargin.controllers', [])
    .controller('keyPostSalesAllOpProfitPerMarginCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function ($scope, restClient, reportService, config) {
        /**
         * Global functions
         */
        ...
        $scope.showReport = function () {
            ...
            $scope.draw(restClient(config.currentMode).queryPostSalesOverallPercentageIncomeReport, params);
        };
