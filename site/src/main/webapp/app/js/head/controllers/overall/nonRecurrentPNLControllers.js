...
angular.module('overallNonRecurrentPNL.controllers', [])
	.controller('overallNonRecurrentPNLCtrl', ['$scope', 'ReportRestClient', 'ReportService', 'config', function($scope, restClient, reportService, config) {
		/**
		 * Global functions
		 */
    	...
    	$scope.showReport = function() {
        	...
        	$scope.draw(restClient(config.currentMode).queryNonRecurrentPNLReport, params);
        };
