		...
		return function(mode) {
        	var services = {
	        	...
	        	local: $resource(
		            ...
		            queryNewVehicleRetailSalesReport: {method: 'GET', params: {path: '', subpath:'queryNewVehicleRetailSalesReport.json', subpath2:''}, isArray: false},
		            queryNewVehicleSalesReport: {method: 'GET', params: {path: '', subpath:'queryNewVehicleSalesReport.json', subpath2:''}, isArray: false},
