...
INSERT INTO UserInfo SELECT 'superadmin', 'GGz3dMl7YKHBBu9xjRCXCmoG4GvviVU9muZdk4qIbq4=', 0, null, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'admin', 'SCgxDIJCG248l/33bxMv4KSfCr/YMyId1+aA1IGtv9Y=', 1, null, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changjin', 'n6CquLgvsJjmslyrMMJ/EuoeYq7GapTkdloc+TOxw1s=', 2, 1, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changyao', 'eKlYt6bOE5ZBFvThjICSNkSX1Pw5v0qNVYe9LnbxPs4=', 2, 2, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'guangben', 'R7Z+52irSlMTt9IUyiqgiXOq7vtvrQpnAXfYoQczdZU=', 2, 3, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changsheng', 'j7wMAHzrcz38LFtBveS8yf/R6DSb4UjBU8MpDavmz3M=', 2, 4, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changyi', 'aFOX4zD+sddnQNggoVmIbUQmmp+2UJko5PaKUnet/80=', 2, 5, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changhao', 'iR+IxOJvJqDunHM3g3++ck6lckZEQY1W+rTsYSHl9II=', 2, 6, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changjie', 'SR6sw3fNoAB+kIcCK3hk1hPQ2cqTwem6obyhejnFM9A=', 2, 7, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changli', '9ZxOeqTtCzzLDNtSKPTyTcpn90eG8hiD3yJyftCKzZA=', 2, 8, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changda', 'OppK5ytWBdOErRR3+ipomW6Z85rSH8GgCDBlfTevR1k=', 2, 9, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'guangfeng', '+LcTilpinvsERvRYtxdzMjuPLh/p2soRXubVD3REbX0=', 2, 10, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changning', 'HjKdle7RVUwmO6gKJ7p+yetENq6jyJRRPa6HbRMVkLY=', 2, 11, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changkai', 'k61GgrDxhb+pqifYsGUCkEq0iez/Q4BkMkL5LHbggQs=', 2, 12, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changjing', '43pVjB9MgXs0Uc6xcR+u+fKNPZawKxcGCLhmmcweB4o=', 2, 13, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'njchangyi', 'aFOX4zD+sddnQNggoVmIbUQmmp+2UJko5PaKUnet/80=', 2, 14, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changjun', 'er6oVLQ8BA9o/r6PE8V1JfZ6QDNZ01OMSCpyoHd3jaM=', 2, 15, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changwei', 'JlSGTcIovTnWOSXzQie2I+Y8nQz2mVHpqWlT5fltUt0=', 2, 16, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changyue', 'FoS+KlCqxnMcI8sYHXdVf+2aWnFFStBwmd5+ygBR3gM=', 2, 17, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changkun', 'BejWDFjgG71DOai8IKqd7uLTshqDhooWkNWNCaxi6DU=', 2, 18, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changjia', 'ku/hnfclLTPeZK2y2dbqBwf0iUgixzNGVISQkEMjgDM=', 2, 19, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'changguan', 'SASPoLl7RWFxPZzxWzMthAPEhfBbAhB4wfptYrn7plU=', 2, 20, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
INSERT INTO UserInfo SELECT 'headquarter', 'uaKtisih50nJyRVwud/cBOFhqNLRiiEgojCjv01Ez44=', 3, null, true, 0, '2014-01-01 08:00:00.000', '9999-01-01 08:00:00', 'admin';
...
INSERT INTO Vehicle SELECT 2, '微型车 Mini 理念1.3', 1, 0, current_timestamp;
INSERT INTO Vehicle SELECT 3, '小型车 Sub Compact 雅力士1.6', 1, 1, current_timestamp;
INSERT INTO Vehicle SELECT 4, '小型车 Sub Compact 飞度1.5', 1, 1, current_timestamp;
INSERT INTO Vehicle SELECT 5, '紧凑型 (A) Compact', 1, 2, current_timestamp;
INSERT INTO Vehicle SELECT 6, '紧凑型 (A) Compact 锋范1.5', 1, 2, current_timestamp;
INSERT INTO Vehicle SELECT 7, '紧凑型 (A) Compact 博跃', 1, 2, current_timestamp;
INSERT INTO Vehicle SELECT 8, '紧凑型 (B) Compact', 1, 3, current_timestamp;
INSERT INTO Vehicle SELECT 9, '紧凑型 (B) Compact 菲亚特500', 1, 3, current_timestamp;
INSERT INTO Vehicle SELECT 10, '紧凑型 (C) Compact', 1, 4, current_timestamp;
INSERT INTO Vehicle SELECT 11, '紧凑型 - 菲翔（畅享版 干式双离合）1.4T', 1, 4, current_timestamp;
INSERT INTO Vehicle SELECT 12, '中型车 (A) Mid-Size', 1, 5, current_timestamp;
INSERT INTO Vehicle SELECT 13, '中型车 (A) Mid-Size 传祺 1.8 AT 手自一体尊贵版', 1, 5, current_timestamp;
INSERT INTO Vehicle SELECT 14, '中型车 (B) Mid-Size', 1, 6, current_timestamp;
INSERT INTO Vehicle SELECT 15, '中型车 (B) Mid-Size 雅阁2.0 (GP1)', 1, 6, current_timestamp;
INSERT INTO Vehicle SELECT 16, '中型车 (B) Mid-Size 凯美瑞2.0', 1, 6, current_timestamp;
INSERT INTO Vehicle SELECT 17, '中型车 (B) Mid-Size 传祺 2.0 AT 手自一体精英版', 1, 6, current_timestamp;
INSERT INTO Vehicle SELECT 18, '中型车 (C) Mid-Size', 1, 7, current_timestamp;
INSERT INTO Vehicle SELECT 19, '中型车 (C) Mid-Size 雅阁2.4', 1, 7, current_timestamp;
INSERT INTO Vehicle SELECT 20, '中型车 (C) Mid-Size 凯美瑞2.5', 1, 7, current_timestamp;
INSERT INTO Vehicle SELECT 21, '大中型 (A) Full Size', 1, 8, current_timestamp;
INSERT INTO Vehicle SELECT 22, '大中型 (B) Full Size', 1, 9, current_timestamp;
INSERT INTO Vehicle SELECT 23, '大中型 (C) Full Size', 1, 10, current_timestamp;
INSERT INTO Vehicle SELECT 24, '豪华车-紧凑型 (A) Luxury Sedan Compat', 1, 11, current_timestamp;
INSERT INTO Vehicle SELECT 25, '豪华车-紧凑型 (B) Luxury Sedan Compat', 1, 12, current_timestamp;
INSERT INTO Vehicle SELECT 26, '豪华车-中型 (A) Luxury Sedan Mid-Size', 1, 13, current_timestamp;
INSERT INTO Vehicle SELECT 27, '豪华车-中型 (A) Luxury Sedan Mid-Size ES250精英版', 1, 13, current_timestamp;
INSERT INTO Vehicle SELECT 28, '豪华车-中型 (B) Luxury Sedan Mid-Size', 1, 14, current_timestamp;
INSERT INTO Vehicle SELECT 29, '豪华车-中型 (B) Luxury Sedan Mid-Size IS250运动版', 1, 14, current_timestamp;
INSERT INTO Vehicle SELECT 30, '豪华车-中型 (C) Luxury Sedan Mid-Size', 1, 15, current_timestamp;
INSERT INTO Vehicle SELECT 31, '豪华车-中型 (C) Luxury Sedan Mid-Size GS', 1, 15, current_timestamp;
INSERT INTO Vehicle SELECT 32, '豪华车-大型 (A) Luxury Sedan Full Size', 1, 16, current_timestamp;
INSERT INTO Vehicle SELECT 33, '豪华车-大型 (A) Luxury Sedan Full Size LS', 1, 16, current_timestamp;
INSERT INTO Vehicle SELECT 34, '豪华车-大型 (B) Luxury Sedan Full Size', 1, 17, current_timestamp;
INSERT INTO Vehicle SELECT 35, '豪华车-大型 (C) Luxury Sedan Full Size', 1, 18, current_timestamp;
INSERT INTO Vehicle SELECT 36, '跑车 Sports Car 杰路驰', 1, 19, current_timestamp;
INSERT INTO Vehicle SELECT 37, '新能源车 Hybrid 凯美瑞 尊瑞', 1, 20, current_timestamp;
INSERT INTO Vehicle SELECT 38, '新能源车 Hybrid CRZ', 1, 20, current_timestamp;
INSERT INTO Vehicle SELECT 39, '新能源车 Hybrid 传祺AE', 1, 20, current_timestamp;
INSERT INTO Vehicle SELECT 40, '新能源车 Hybrid CT', 1, 20, current_timestamp;
INSERT INTO Vehicle SELECT 41, '跨界车 Cross-Over', 1, 21, current_timestamp;
INSERT INTO Vehicle SELECT 42, '跨界车 Cross-Over 菲跃（豪华版）', 1, 21, current_timestamp;
INSERT INTO Vehicle SELECT 43, '跨界车 Cross-Over 歌诗图2.4', 1, 21, current_timestamp;
INSERT INTO Vehicle SELECT 44, '跨界车 Cross-Over 威飒', 1, 21, current_timestamp;
INSERT INTO Vehicle SELECT 45, 'SUV - (A) 紧凑型 Compact', 2, 22, current_timestamp;
INSERT INTO Vehicle SELECT 46, 'SUV - (A) 紧凑型 Compact 劲炫', 2, 22, current_timestamp;
INSERT INTO Vehicle SELECT 47, 'SUV - (A) 紧凑型 Compact GS5 2.0豪华版', 2, 22, current_timestamp;
INSERT INTO Vehicle SELECT 48, 'SUV - (B) 紧凑型 Compact', 2, 23, current_timestamp;
INSERT INTO Vehicle SELECT 49, 'SUV - (C) 紧凑型 Compact', 2, 24, current_timestamp;
INSERT INTO Vehicle SELECT 50, 'SUV - (A) 中型 Mid 汉兰达 2.7 运动豪华版', 2, 25, current_timestamp;
INSERT INTO Vehicle SELECT 51, 'SUV - (B) 中型 Mid 汉兰达 3.5 运动豪华版', 2, 26, current_timestamp;
INSERT INTO Vehicle SELECT 52, 'SUV - (C) 中型 Mid Size 酷路泽', 2, 27, current_timestamp;
INSERT INTO Vehicle SELECT 53, 'SUV - (A) 大型 (A) Large', 2, 28, current_timestamp;
INSERT INTO Vehicle SELECT 54, 'SUV - (A) 大型 (A) Large 帕杰罗V73', 2, 28, current_timestamp;
INSERT INTO Vehicle SELECT 55, 'SUV - (B) 大型 (B) Large', 2, 29, current_timestamp;
INSERT INTO Vehicle SELECT 56, 'SUV - (C) 大型 (C) Large', 2, 30, current_timestamp;
INSERT INTO Vehicle SELECT 57, 'SUV - (A) 豪华中型 Luxury Mid-Size', 2, 31, current_timestamp;
INSERT INTO Vehicle SELECT 58, 'SUV - (A) 豪华中型 Lux - GX', 2, 31, current_timestamp;
INSERT INTO Vehicle SELECT 59, 'SUV - (B) 豪华中型 Luxury Mid-Size', 2, 32, current_timestamp;
INSERT INTO Vehicle SELECT 60, 'SUV - (B) 豪华中型 Luxury - RX270典雅版', 2, 32, current_timestamp;
INSERT INTO Vehicle SELECT 61, 'SUV - (C) 豪华中型 Luxury Mid-Size', 2, 33, current_timestamp;
INSERT INTO Vehicle SELECT 62, 'SUV - (A) 豪华大型 Luxury Large', 2, 34, current_timestamp;
INSERT INTO Vehicle SELECT 63, 'SUV - (A) 豪华大型 Lux - LX', 2, 34, current_timestamp;
INSERT INTO Vehicle SELECT 64, 'SUV - (B) 豪华大型 Luxury Large', 2, 35, current_timestamp;
INSERT INTO Vehicle SELECT 65, 'SUV - (C) 豪华大型 Luxury Large', 2, 36, current_timestamp;
INSERT INTO Vehicle SELECT 66, 'MPV (A) 逸致 180G豪华版', 2, 37, current_timestamp;
INSERT INTO Vehicle SELECT 67, 'MPV (B) Multi-Purpose Vehicle', 2, 38, current_timestamp;
INSERT INTO Vehicle SELECT 68, 'MPV (B) Multi-Purpose Vehicle 奥德赛2.4', 2, 38, current_timestamp;
INSERT INTO Vehicle SELECT 69, 'MPV (C) 埃尔法 3.5 豪华版', 2, 39, current_timestamp;
