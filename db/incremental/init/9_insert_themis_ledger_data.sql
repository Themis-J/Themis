...
INSERT INTO DealerLedgerMetadata SELECT 85, 'purchaseDate', '购车日期', 'input', null, 1, 2;
...
INSERT INTO DealerLedgerMetadata SELECT 99, 'maintenanceTechnician', '保养、机修、保修保养技师', 'select', '小李,小王', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 100, 'repairTechnician', '保养、机修、保修维修技师', 'select', '快修一组,机修二班', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 101, 'maintenanceType', '维修类型', 'multiselect', '首保,定期保养,一般维修,保修,钣喷,美容', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 102, 'insuranceType', '定保类型', 'select', '5K,10K,15K', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 103, 'bodyShopPostSalesConsultant', '钣喷售后顾问', 'select', '小李,小王', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 104, 'sheetMetalTechinician', '钣金技师', 'select', '小李,小王,快修一组,机修二班', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 105, 'paintSprayTechinician', '喷漆技师', 'select', '小李,小王,快修一组,机修二班', 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 106, 'mineralEngineOil', '矿物机油', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 107, 'synthesizedEngineOil', '合成机油', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 108, 'airFilterElement', '空气滤芯', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 109, 'airConditionerFilterElement', '空调滤芯', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 110, 'gasolineFilterElement', '汽油滤芯', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 111, 'brakeFluid', '刹车油', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 112, 'sparkPlug', '火花塞', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 113, 'directionEngineOil', '方向机油', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 114, 'transmissionOil', '变速箱油', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 115, 'coolingFluid', '冷却液', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 116, 'timingChain', '正时链/皮带', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 117, 'lubricationSystemClean', '润滑系统清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 118, 'transmissionClean', '变速箱系统清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 119, 'directionSystemClean', '动力转向清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 120, 'coolingSystemClean', '冷却系统清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 121, 'airConditionerClean', '空调系统清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 122, 'fuelSystemClean', '燃油系统清洗', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 123, 'otherSystemClean', '其它系统养护', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 124, 'maintenanceProductAmount', '养护类产品总数', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 125, 'tyreCount', '轮胎', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 126, 'batteryCount', '电池', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 127, 'sparkPlugCount', '火花塞', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 128, 'wiperBladeCount', '雨刮片', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 129, 'maintenanceManHourRevenuePaidPart', '保养、机修项目客户付费维修工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 130, 'maintenanceManHourDiscountPaidPart', '保养、机修项目客户付费维修工时打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 131, 'maintenanceManHourCouponPaidPart', '保养、机修项目客户付费维修工时代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 132, 'maintenanceManHourCostPaidPart', '保养、机修项目客户付费维修工时成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 133, 'maintenanceManHourRevenueUnpaidPart', '保修项目工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 134, 'maintenanceManHourCostUnpaidPart', '保修项目工时成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 135, 'sheetMetalManHourRevenue', '钣金工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 136, 'paintSprayManHourRevenue', '喷漆工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 137, 'bodyShopManHourDiscount', '钣喷维修项目工时打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 138, 'bodyShopManHourCoupon', '钣喷维修项目工时代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 139, 'bodyShopManHourCost', '钣喷维修项目工时成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 140, 'accessoryManHourRevenue', '精品安装工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 141, 'accessoryManHourDiscount', '精品安装工时打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 142, 'accessoryManHourCoupon', '精品安装工时代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 143, 'accessoryManHourCost', '精品安装工时成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 144, 'otherManHourRevenue', '其他维修项工时收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 145, 'otherManHourDiscount', '其他维修项工时打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 146, 'otherManHourCoupon', '其他维修项工时代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 147, 'otherManHourCost', '其他维修项工时成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 148, 'maintenancePartsRevenue', '零件收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 149, 'maintenancePartsDiscount', '零件打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 150, 'maintenancePartsCoupon', '零件代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 151, 'maintenancePartsCost', '零件成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 152, 'accessoryPartsRevenue', '精品收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 153, 'accessoryPartsDiscount', '精品打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 154, 'accessoryPartsCoupon', '精品代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 155, 'accessoryPartsCost', '精品成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 156, 'maintenanceProductRevenue', '养护产品收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 157, 'maintenanceProductDiscount', '养护产品打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 158, 'maintenanceProductCoupon', '养护产品代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 159, 'maintenanceProductCost', '养护产品成本', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 160, 'vehicleDecorationRevenue', '汽车美容收入', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 161, 'vehicleDecorationDiscount', '汽车美容打折', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 162, 'vehicleDecorationCoupon', '汽车美容代金券', 'input', null, 1, 2;
INSERT INTO DealerLedgerMetadata SELECT 163, 'vehicleDecorationCost', '汽车美容成本', 'input', null, 1, 2;