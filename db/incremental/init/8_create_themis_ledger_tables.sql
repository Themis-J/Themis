...
(
   ...
   vehicleSalesMargin double precision NOT NULL DEFAULT 0,
   ...
   usedVehicleMargin double precision NOT NULL DEFAULT 0,
   usedVehicleManufacturerSubsidy double precision NOT NULL DEFAULT 0,
   tradeInMargin double precision NOT NULL DEFAULT 0,
   ...
   installmentMargin double precision NOT NULL DEFAULT 0,
   ...
   extendedWarrantyMargin double precision NOT NULL DEFAULT 0,
   ...
   memberCardMargin double precision NOT NULL DEFAULT 0,
   ...
   giftAmount double precision NOT NULL DEFAULT 0,
   inventoryDays double precision NOT NULL DEFAULT 0,
   financingRate double precision NOT NULL DEFAULT 0,
   interests double precision NOT NULL DEFAULT 0,
   managementFee double precision NOT NULL DEFAULT 0,
   inventoryFinancingAmount double precision NOT NULL DEFAULT 0,
   ...
   pushMoneyAmount double precision NOT NULL DEFAULT 0,
...
(
   ...
   maintenanceManHourMarginPaidPart double precision NOT NULL DEFAULT 0,
   ...
   maintenanceManHourMarginUnpaidPart double precision NOT NULL DEFAULT 0,
   ...
   bodyShopManHourMargin double precision NOT NULL DEFAULT 0,
   ...
   accessoryManHourMargin double precision NOT NULL DEFAULT 0,
   ...
   discountedManHourRevenue double precision NOT NULL DEFAULT 0,
   manHourMargin double precision NOT NULL DEFAULT 0,
   ...
   maintenancePartsMargin double precision NOT NULL DEFAULT 0,
   ...
   accessoryPartsMargin double precision NOT NULL DEFAULT 0,
   ...
   maintenanceProductMargin double precision NOT NULL DEFAULT 0,
   discountedPartsRevenue double precision NOT NULL DEFAULT 0,
   partsMargin double precision NOT NULL DEFAULT 0,
   ...
   vehicleDecorationMargin double precision NOT NULL DEFAULT 0,
   postSalesMargin double precision NOT NULL DEFAULT 0,
   version integer NOT NULL,
   updatedBy varchar(20) NOT NULL,
