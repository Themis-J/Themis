...
angular.module('overallAbs.controllers', [])
	.controller('overallAbsCtrl', ['$scope', '$http', 'ReportRestClient', 'ReportService', function($scope, $http, restClient, reportService) {
		$scope.charts = [
    	...
    	$scope.showReport = function()
        {
        	...
        	if ( $scope.selectedTime == 1 ) {
        		params = {year: $scope.currentYear, monthOfYear: $scope.currentMonth};
